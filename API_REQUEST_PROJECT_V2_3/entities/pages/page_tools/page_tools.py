...
class PageTools():
    ...
    def find_element_by_text(self, tag_element, search_text):
        ...
        # element_bs4 = BeautifulSoup(element_html, "html.parser")
        # print(element_bs4)
        # html = self.getHTML_bs()
        # element = html.find(tag_element, text=search_text)
    ...
    def get_parent_element(self, element, parent_class, tag):
        ...
        # parent_element = element.find_parent(tag, class_=parent_class)
